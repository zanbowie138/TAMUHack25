...
const AboutSection = () => {
  return (
    <div className="flex items-center justify-between p-8 bg-[#242424] pb-0">
      {" "}
      
      <div className="w-1/2 pr-8 pl-24">
        <div className="mb-4">
          <p className="text-sm text-gray-600">What is</p>
          <h2 className="text-4xl font-bold bg-gradient-to-r from-white to-pink-300 bg-clip-text text-transparent leading-tight pb-2">
            ToyoFit
          </h2>
        </div>
        <p className="font-poppins font-extralight text-xl text-[#C8C8C8] opacity-80">
          Shopping for your next Toyota just got smarter. ToyoFit blends advanced sentiment analysis with a
