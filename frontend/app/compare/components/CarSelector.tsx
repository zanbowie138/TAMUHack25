          ...
          <Combobox immediate value={selectedCar} onChange={handleCarChange} onClose={() => setQuery("")}>
            <div className="relative">
              <ComboboxInput
                ...
                displayValue={(car: Car) => `${car.year} ${capitalize(car.model)}`}
